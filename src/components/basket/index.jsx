...
import { GoBackButton, TextButton } from '../buttons';
import './style.scss';

export default () => {
  return false ? <Basket /> : <BasketEmpty />
};

const Basket = () => (
  <>
    <BasketTop />
    <BasketItems data={basket_info} />
    <BasketBottom />
  </>
);
...
const BasketBottom = () => (
  <div className="basket__bottom">
    ...
    <div className="basket__bottom-buttons">
      <GoBackButton />
      <TextButton text="Оплатить сейчас" />
    </div>
  </div>
);
